...
export default function Example() {
  ...
  return (
    <header className="fixed top-0 bg-white w-full z-50 border-b">
      <nav className="mx-auto flex max-w-7xl items-center justify-between px-4 py-2.5 lg:px-8 " aria-label="Global">
        ...
        <div className="hidden lg:flex lg:flex-1 lg:justify-end">
          <Link href="/login" className="text-sm font-semibold leading-6 text-gray-800 bg-blue-500 py-3 px-6 rounded-md">
